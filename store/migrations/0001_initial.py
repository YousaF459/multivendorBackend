# Generated by Django 5.2.6 on 2025-10-20 07:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.FileField(blank=True, default='category.png', null=True, upload_to='category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('full_name', models.CharField(default=True, max_length=100, null=True)),
                ('email', models.CharField(default=True, max_length=100, null=True)),
                ('mobile', models.CharField(default=True, max_length=100, null=True)),
                ('address', models.CharField(default=True, max_length=100, null=True)),
                ('city', models.CharField(default=True, max_length=100, null=True)),
                ('state', models.CharField(default=True, max_length=100, null=True)),
                ('country', models.CharField(default=True, max_length=100, null=True)),
                ('oid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefghijk', length=10, max_length=10, prefix='', unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total', models.DecimalField(decimal_places=2, default=0.0, max_digits=12)),
                ('country', models.CharField(default=True, max_length=100, null=True)),
                ('size', models.CharField(default=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=100)),
                ('image', models.FileField(blank=True, default='product.png', null=True, upload_to='products')),
                ...
                ('pid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefghijk', length=10, max_length=10, prefix='', unique=True)),
                ('slug', models.SlugField(unique=True)),
                ('date', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active', models.BooleanField(default=True)),
                ('gid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefghijk', length=10, max_length=10, prefix='', unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('size', models.CharField(default=True, max_length=100, null=True)),
                ('color', models.CharField(default=True, max_length=100, null=True)),
                ('cart_id', models.CharField(default=True, max_length=100, null=True)),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.product')),
            ],
